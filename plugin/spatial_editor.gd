...
func startup():
	var _err = _plugin.selector.selection_changed.connect(self._on_selection_change)

func teardown():
	var _err = _plugin.selector.selection_changed.disconnect(self._on_selection_change)
